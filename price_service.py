...
class PriceService:
    ...
    def get_crypto_price(self, symbol: str) -> Optional[float]:
        ...
        try:
            ...
            if crypto_id in data and 'eur' in data[crypto_id]:
                ...
                # Mettre en cache
                self.cache[f"crypto_{symbol_lower}"] = {
                    'price': price,
                    'timestamp': time.time()
                }
    ...
    def calculate_investment_performance(self, investments: List[Dict], asset_type: str) -> List[Dict]:
        """
    ...
    def calculate_portfolio_summary(self, crypto_investments: List[Dict], stock_investments: List[Dict]) -> Dict:
        """
