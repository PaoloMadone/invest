...
class TestIntegration:
    ...
    def test_workflow_complet_bourse(self):
        ...
        achat_data = creer_donnees_investissement(
            "2024-01-15", "AAPL", 200.0, 100.0, False  # 200€  # 100€ par action
        )
        ...
        vente_data = creer_donnees_vente(
            "2024-02-15", "AAPL", 150.0, 150.0  # 150€  # 150€ par action
        )
    ...
    def test_workflow_complet_crypto(self):
        ...
        achat_data = creer_donnees_investissement("2024-02-01", "BTC", 400.0, 40000.0, False)
        ...
        vente_data = creer_donnees_vente("2024-03-01", "BTC", 250.0, 50000.0)  # 0.005 * 50000
    ...
    def test_validation_erreurs(self):
        ...
        erreurs = valider_donnees_vente(
            200.0, 10.0, "TEST", 20.0, [achat_data]
        )  # Veut vendre 20, n'a que 10
        assert len(erreurs) > 0
    ...
    def test_integration_performance_calculs(self):
        ...
        with patch.object(self.price_service, "get_current_price", mock_prices):
            ...
            perf_investments = self.price_service.calculate_investment_performance(
                investments, "bourse"
            )
